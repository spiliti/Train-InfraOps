...
ALLOW_SAVE_PASSWORD = strtobool(os.getenv('ALLOW_SAVE_PASSWORD', "False"))
UPGRADE_CHECK_ENABLED = strtobool(os.getenv('UPGRADE_CHECK_ENABLED', "False"))
SECURITY_RECOVERABLE = strtobool(os.getenv('SECURITY_RECOVERABLE', "False"))
SECURITY_CHANGEABLE = strtobool(os.getenv('SECURITY_CHANGEABLE', "False"))
ALLOW_SAVE_PASSWORD = strtobool(os.getenv('ALLOW_SAVE_PASSWORD', "False"))
MAX_SESSION_IDLE_TIME = 900
PGCONNECT_TIMEOUT = 300
PGTZ = 'Asia/Calcutta'
